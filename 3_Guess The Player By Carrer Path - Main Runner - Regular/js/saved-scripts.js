...
const VOICE_FREEZE_MIGRATION_FLAG = "footballQuizVoiceFreezeMigrated_career_regular_v2";
...
async function loadScript(script) {
    ...
    appState.levelsData = script.levels.map(lvl => {
        ...
        // (its per-player reset can't tell a freshly-loaded level from a player
        // change — see the __suppressPictureReset handling in pitch-render.js).
