...
const RUNNER_VARIANT = "Career Path Regular";
...
/** Phrase pick for one reveal slot.
    ...
    - Spanish: never plain — always pull a sentence so the player name is never spoken alone. */
