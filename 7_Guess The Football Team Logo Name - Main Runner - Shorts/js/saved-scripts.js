...
const VOICE_FREEZE_MIGRATION_FLAG = "footballQuizVoiceFreezeMigrated_team_logo_name_shorts_v2";
...
const KEY_SCRIPTS = "footballQuizScripts_team_logo_name_shorts_v1";
const KEY_FOLDERS = "footballQuizFolders_team_logo_name_shorts_v1";
const KEY_FOLDER_STATES = "footballQuizFolderStates_team_logo_name_shorts_v1";
...
const SAVE_SERVER = createSavedScriptsServerSync("team_logo_name_shorts", {
    KEY_SCRIPTS,
    KEY_FOLDERS,
    KEY_FOLDER_STATES,
});
    ...
    if (importTeams) {
        ...
        for (let i = 0; i < names.length; i++) {
            ...
            if (cands.length === 0) {
                ...
                // Headless: take the best (longest-name) candidate; the list is
                // already sorted so the most specific match wins.
                resolved[i] = cands[0];
            }
        }
    } else {
