...
// Concurrency 6 + a generous per-frame timeout: a level frame decodes player photos
// at once; at concurrency 10 the first such frame can exceed the default 30s delayRender timeout.
