...
rem reuses that runner's installed Remotion + remotion.config.ts (the @shared alias and
rem the shared public folder), pointed at the aggregator entry registering all 9.
...
echo.
echo  Starting Remotion Studio - ALL Projects
...
call npx.cmd remotion studio "..\_studio\studio-entry.tsx" --port 3000
