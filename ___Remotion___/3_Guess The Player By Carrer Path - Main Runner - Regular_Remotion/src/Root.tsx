...
export const RemotionRoot: React.FC = () => {
  ...
  return (
    <Composition
      ...
      height={1080}
      schema={demoSchema}
      defaultProps={{"save":"Mixed players 5" as const,"levels":"2" as const,"formation":"Auto (from save)" as const,"language":"English" as const,"competition":"Europa League" as const,"transition":"Diagonal Wipe" as const}}
    />
  );
};
