...
const COMPOSITION_ID = "Guess-The-Player-By-Career-Path-Regular";
const QUIZ_NAME = "Guess The Player By Career Path";
...
// Paths contain spaces → pass ONE quoted command string (shell:true) so the shell parses the quotes.
