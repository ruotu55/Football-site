...
// Title text MUST match the quiz-title voice (and the runner's i18n landing title):
//   EN voice "Guess the football team name by players' nationality"
//   ES voice "Adivina el equipo por la nacionalidad de los jugadores"
const STRINGS = {
  English: {
...
export const Intro: React.FC<{ language: Language; questionsCount: number }> = ({
  language,
  questionsCount,
}) => {
