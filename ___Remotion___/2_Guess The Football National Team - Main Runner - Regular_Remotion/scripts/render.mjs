...
//   ___Remotion___/Ready Videos/<save>/<language>/<save> - <language>.mp4
...
const COMPOSITION_ID = "Guess-The-Football-National-Team-Regular";
...
// "Ready Videos" sits next to the project, inside ___Remotion___/.
const outDir = path.resolve(projectDir, "..", "Ready Videos", save, language);
fs.mkdirSync(outDir, { recursive: true });
const outFile = path.join(outDir, `${save} - ${language}.mp4`);
