...
// Usage:  npm run render -- --save "Logos 1" --language English --levels All [--fps 60]
import { spawnSync } from "node:child_process";
import fs from "node:fs";
import path from "node:path";
import { fileURLToPath } from "node:url";

const COMPOSITION_ID = "Guess-The-Football-Team-Logo-Name-Regular";
const QUIZ_NAME = "Guess The Team Logo Name";
