/**
 * Formation presets ported from js/formations.js.
 * x/y are percent coordinates of the pitch box (left% / top%)
 * where y=100 is the goal-line (GK end) and y=0 is the attack end.
 */
...
export const FORMATIONS: Formation[] = [
  ...
  },
  {
    ...
    slots: [
      ...
      { role: "mid", position: "Attacking Midfield",   x: 50, y: 47 },
