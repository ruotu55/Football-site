...
async function init() {
    ...
    initNameDescriptionGenerator({
        ...
        quizKey: "nat-by-club",
        quizTitle: "GUESS THE FOOTBALL NATIONAL TEAM BY PLAYERS",
    ...
    if (!didRestoreState) {
        ...
        if (els.inEasy) els.inEasy.value = String(easy);
        if (els.inMedium) els.inMedium.value = String(medium);
    ...
    if (els.inEasy) els.inEasy.oninput = updateLanding;
