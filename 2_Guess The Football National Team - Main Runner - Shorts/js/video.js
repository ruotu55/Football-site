...
const SHORTS_INTRO_QUIZ_TITLE_LINE_1 = "GUESS THE FOOTBALL NATIONAL";
const SHORTS_INTRO_QUIZ_TITLE_LINE_2 = "TEAM NAME BY PLAYERS' CLUB";
const SHORTS_INTRO_QUIZ_TITLE_LINE_1_ES = "ADIVINA LA SELECCIÓN";
const SHORTS_INTRO_QUIZ_TITLE_LINE_2_ES = "POR LOS CLUBES DE LOS JUGADORES";
...
export function startVideoFlow() {
  ...
  if (appState.currentLevelIndex > 0 && !state.currentSquad) {
