@echo off
rem Run (no browser, PowerShell): & "C:\Users\Rom\Documents\GitHub\Football Channel\999_Calander\run_site.bat" --no-browser
setlocal
set "HERE=%~dp0"
...
:run
rem Listen on all interfaces so other PCs on the LAN can open the calendar (override with: --host 127.0.0.1)
