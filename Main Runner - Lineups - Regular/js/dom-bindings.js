...
export function bindDomElements() {
    ...
    els.thumbnailMakerPage = document.getElementById("thumbnail-maker-page");
    els.openThumbnailMakerBtn = document.getElementById("open-thumbnail-maker-btn");
    els.thumbnailMakerBackBtn = document.getElementById("thumbnail-maker-back-btn");
    els.thumbnailMakerAddBtn = document.getElementById("thumbnail-maker-add-btn");
    els.thumbnailMakerResetBtn = document.getElementById("thumbnail-maker-reset-btn");
    els.thumbnailMakerCanvas = document.getElementById("thumbnail-maker-canvas");
    els.thumbnailPickerModal = document.getElementById("thumbnail-picker-modal");
    els.thumbnailPickerTitle = document.getElementById("thumbnail-picker-title");
    els.thumbnailPickerSearch = document.getElementById("thumbnail-picker-search");
    els.thumbnailPickerSelect = document.getElementById("thumbnail-picker-select");
    els.thumbnailPickerCancel = document.getElementById("thumbnail-picker-cancel");
    els.thumbnailPickerApply = document.getElementById("thumbnail-picker-apply");
