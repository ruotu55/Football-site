...
export const COMPETITIONS: {
  ...
  { id: "premier-league", label: "Premier League", recipe: { c1: "#2b0036", c2: "#ff2d8b", pattern: "chevron", patternHex: "#04f5ff", patternAlpha: 0.16, motion: "drop" } },
  { id: "la-liga", label: "La Liga", recipe: { c1: "#001433", c2: "#ff5a5a", pattern: "chevron", patternHex: "#ffffff", patternAlpha: 0.12, motion: "drop" } },
  { id: "bundesliga", label: "Bundesliga", recipe: { c1: "#141414", c2: "#d50a17", pattern: "diagonal", patternHex: "#ffffff", patternAlpha: 0.1, motion: "drop" } },
  { id: "serie-a", label: "Serie A", recipe: { c1: "#021a3a", c2: "#1e63b8", pattern: "diagonal", patternHex: "#ffffff", patternAlpha: 0.1, motion: "drop" } },
  { id: "ligue-1", label: "Ligue 1", recipe: { c1: "#07173a", c2: "#a6d400", pattern: "chevron", patternHex: "#ffffff", patternAlpha: 0.12, motion: "drop" } },
  { id: "world-cup", label: "World Cup", recipe: { c1: "#4a0a16", c2: "#c79a3a", pattern: "rays", patternHex: "#ffe9a8", patternAlpha: 0.1, motion: "drop" } },
  { id: "euro", label: "Euro", recipe: { angle: 135, c1: "#07303a", c2: "#0d2a66", pattern: "chevron", patternHex: "#ffffff", patternAlpha: 0.05, motion: "drop" } },
];
...
// Bold chevrons tile (Premier League look).
export function chevronTileUri(lineHex: string, alpha: number): string {
  const { r, g, b } = hexToRgb(lineHex);
  const stroke = `rgb(${r}, ${g}, ${b})`;
  const svg = `<svg xmlns="http://www.w3.org/2000/svg" width="170" height="170" viewBox="0 0 170 170"><g fill="none" stroke="${stroke}" stroke-opacity="${alpha.toFixed(3)}" stroke-width="26"><path d="M-30,46 L85,-26 L200,46"/><path d="M-30,128 L85,56 L200,128"/><path d="M-30,210 L85,138 L200,210"/></g></svg>`;
  return svgDataUri(svg);
}
