...
export function bindDomElements() {
    ...
    els.tabBtnVoice = document.getElementById("tab-btn-voice");
    ...
    els.panelVoice = document.getElementById("panel-voice");
    ...
    els.btnImportScript = document.getElementById("btn-import-script");
    els.btnCreateFolder = document.getElementById("btn-create-folder");
    els.importScriptModal = document.getElementById("import-script-modal");
    els.importScriptModalClose = document.getElementById("import-script-modal-close");
    els.importScriptText = document.getElementById("import-script-text");
    els.importScriptName = document.getElementById("import-script-name");
    els.importScriptError = document.getElementById("import-script-error");
    els.importScriptCancel = document.getElementById("import-script-cancel");
    els.importScriptConfirm = document.getElementById("import-script-confirm");
    els.importDisambigModal = document.getElementById("import-disambig-modal");
    els.importDisambigModalClose = document.getElementById("import-disambig-modal-close");
    els.importDisambigList = document.getElementById("import-disambig-list");
    els.importDisambigCancel = document.getElementById("import-disambig-cancel");
    els.importDisambigConfirm = document.getElementById("import-disambig-confirm");
