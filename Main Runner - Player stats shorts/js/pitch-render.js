...
/** Refit after layout, webfonts, and delayed paints — avoids intermittent microscopic text. */
function scheduleCareerRevealNameFit(revealNameEl) {
  ...
  if (document.body.classList.contains("shorts-mode") && document.fonts?.ready) {
...
export function renderCareer() {
  ...
  if (isShorts) {
    if (showShortsCareerGrid && state.videoMode) {
