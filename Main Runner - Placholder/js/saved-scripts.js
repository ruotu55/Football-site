// js/saved-scripts.js — Main Runner - Placholder (regular)
import {
    appState,
...
const KEY_SCRIPTS = "footballQuizScripts_placholder_regular_v1";
const KEY_FOLDERS = "footballQuizFolders_placholder_regular_v1";
const KEY_FOLDER_STATES = "footballQuizFolderStates_placholder_regular_v1";
const FIXED_SHORTS_MODE = false;

const SAVE_SERVER = createSavedScriptsServerSync("placholder_regular", {
    KEY_SCRIPTS,
    KEY_FOLDERS,
    KEY_FOLDER_STATES,
});
