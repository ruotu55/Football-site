...
**Runner:** 1_Guess The Football Team Name - Main Runner
**Variant:** Regular
**Quiz:** Guess the football club by its name
...
### 4. Size
- **Every mixed video must have at least 35 levels** (*"each mixed video — that is not a competition and just random teams — needs to be at least 35 levels"*). Target ~35–50.
- **Competition** videos (leagues / World Cup / Euro) use that competition's full set of teams — size is whatever the competition has (e.g. Euro = 24, World Cup = 48).
