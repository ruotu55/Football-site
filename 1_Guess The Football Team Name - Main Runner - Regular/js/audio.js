...
/** Build the candidate chain for one reveal, given the chosen phrase. Tries the chosen
    ...
    play "Argentina" instead of "The correct answer is Argentina" when the sentence
    clip wasn't generated. Missing sentence clip = silence (PROD validation must catch
    it before play time). */
