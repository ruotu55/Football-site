...
function publishScheduleAvailability() {
    try {
        ...
        for (const key of Object.keys(blocks)) {
            ...
            // Multiple-choice blocks carry a full script (with levels) and no
            // teams list — count those too so they schedule on the calendar.
...
async function onBlockClick(item) {
    ...
    if (existing) {
        ...
        try {
            ...
            // Carry over any frozen voice picks stashed in the stored script.
