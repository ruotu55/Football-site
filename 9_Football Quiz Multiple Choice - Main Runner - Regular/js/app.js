...
const QUIZ_TYPE_DEFAULT_THEME = {
    ...
    "football-quiz-mcq": { colorId: "quiz-football-mcq", effectId: "rising-soccer-balls", opacity: 4, transitionId: "wc-sweep" },
};
...
export function populateSubTypes() {
    ...
    els.inQuizType.innerHTML = `
      <option value="football-quiz-mcq">FOOTBALL QUIZ - MULTIPLE CHOICE</option>
    `;
...
async function init() {
    ...
    function applyFakeInfoBodyClass() {
        ...
        document.body.classList.toggle(
            "mcq-mode",
            String(els.inQuizType?.value || "") === "football-quiz-mcq",
        );
    }
