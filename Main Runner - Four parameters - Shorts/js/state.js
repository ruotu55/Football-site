...
export const DEFAULT_SHORTS_VIDEO_SILHOUETTE_Y_OFFSET = 0;
...
export const appState = {
  ...
  /** Four-params reveal: stats + career wait for silhouette/flag, then one unified fade (see `pitch-render.js`). */
