// js/saved-scripts.js — Main Runner - Placholder - Shorts
import {
    appState,
...
const KEY_SCRIPTS = "footballQuizScripts_placholder_shorts_v1";
const KEY_FOLDERS = "footballQuizFolders_placholder_shorts_v1";
const KEY_FOLDER_STATES = "footballQuizFolderStates_placholder_shorts_v1";
const FIXED_SHORTS_MODE = true;

const SAVE_SERVER = createSavedScriptsServerSync("placholder_shorts", {
    KEY_SCRIPTS,
    KEY_FOLDERS,
    KEY_FOLDER_STATES,
});
