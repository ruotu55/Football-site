...
QUIZ_TITLE_VOICE_FILE_BY_QUIZ_TYPE = {
    "english": {
        ...
        # cannot collide with folder 6 Regular which uses the same key in the
...
QUIZ_TITLE_PROMPT_BY_QUIZ_TYPE = {
    "english": {
        ...
        "player-by-fake-info": "Hey everyone, let's start. ... GUESS THE FOOTBALL TEAM NAME!!",
    },
    "spanish": {
        "player-by-career": "Hola a todos, empecemos. ... ¡¡ADIVINA AL JUGADOR POR TRAYECTORIA!!",
        "player-by-fake-info": "Hola a todos, empecemos. ... ¡¡ADIVINA EL NOMBRE DEL EQUIPO DE FÚTBOL!!",
    },
}
